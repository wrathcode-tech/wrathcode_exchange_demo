              ...
              <div className="create-item-wrapper plicy_sec" >
                <div className="row align-items-center py-5">
                  <div className="col-lg-12">
                    <div>
                      <h3>Privacy Policy for Wrathcode Exchange</h3>

                      <p>At Wrathcode Exchange.io, accessible from https://cvtrade.io, one of our primary commitments is ensuring the privacy and security of our visitors' information. This Privacy Policy outlines the types of data we collect, how it is used, and the measures we take to protect your privacy.</p>
                      <br />
                      <h3>About Us</h3>

                      <p>Wrathcode Exchange is operated by C.V. TECH SERVICES CO., LTD., a registered company under Thai law with the following details:
                      </p>
                        <ul>
                      ...
                      <p>Wrathcode Exchange.io follows standard procedures for using log files. These files track visits to our site and may include details such as IP addresses, browser types, and referring pages. This data is collected to analyze site usage, monitor security, and gather demographic insights.</p>
                      <br />
                      <h3>Cookies and Tracking</h3>

                      <p>Wrathcode Exchange.io uses cookies to store user preferences and enhance your browsing experience. Cookies help us understand how you interact with our site, allowing us to tailor content and features to suit your needs.</p>
                      <br />
                      ...
                      <p>Wrathcode Exchange respects your privacy rights as outlined under the General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA). If you reside in the EU or California, you have the following rights: Right to access your personal data Right to correct or update inaccurate information Right to request data deletion Right to object to data processing or withdraw consent If you wish to exercise any of these rights, please contact us at info@cvtrade.io.</p>
                      <br />
                      <h3>Children's Privacy</h3>

                      <p>Wrathcode Exchange.io does not knowingly collect personal information from children under the age of 13. If you believe your child has provided us with personal data, please contact us immediately, and we will take the necessary steps to remove such information.</p>
                      <br />
